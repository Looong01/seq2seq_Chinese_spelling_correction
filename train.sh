...
# # 实验3
# python train.py batch_size-32_dropout-0dot25_epochs-20000.py
# python train.py batch_size-64_dropout-0dot25_epochs-20000.py
# python train.py batch_size-128_dropout-0dot25_epochs-20000.py

# # 实验4
# python train.py batch_size-32_dropout-0dot3_epochs-20000.py
# python train.py batch_size-64_dropout-0dot3_epochs-20000.py
# python train.py batch_size-128_dropout-0dot3_epochs-20000.py

# # 实验5
# python train.py batch_size-32_dropout-0dot2_epochs-20000.py
# python train.py batch_size-64_dropout-0dot2_epochs-20000.py
# python train.py batch_size-128_dropout-0dot2_epochs-20000.py